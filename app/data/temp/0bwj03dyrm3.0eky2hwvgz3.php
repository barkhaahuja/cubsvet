...
<!-- Modal -->
<div class="modal fade" id="ModalDepressiveWidget2" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" style="width: 1200px;">
        <div class="modal-content shadow window" id="container" style="height: 800px;">
            ...
            <input type="hidden" id="m11_event" value="">
            ...
            <div style="margin-top: 10px; height:730px; float:left; overflow-x: hidden; overflow-y: auto; width:100%; display:block;" id="fullcontent">
                ...
                <div class="wrapper">
                   ...
                   <div class="lefttopBox" id="sl1" style="display:none;">
                            ...
                            <div class="gwd-div-epbp">
                                ...
                                <div class="singleRight">
                                    ...
                                    <div class="small_btn_rep" id="smb8" style="display:none;">
                                        <button id="leftBtn" data-block="sm8"  data-bblock="smb8" class="TB-PREV smb8">TILBAGE</button>
                            ...
                            <div class="sndtrianglemaindiv_2">
                                <div class="sndrectanglebox_2">
                                    ...
                                    <div class="small_btn" id="smb9b" style="display:none;">
                                        <button id="leftBtn right_leftBtn" class="TB-PREV smb9b" data-block="sm9e" data-bblock="smb9b">TILBAGE</button>
                    ...
                    <div class="maincontiner" id="sm10e" style="display:block;">
                        <div class="center_wrapper">
                            <div class="trianglemaindiv">
                                <div class="rectanglebox">
                                    <div class="image10">
                                ...
                                <div class="sndrectanglebox sndrectangle_center">
                                    <div class="tangleImage">
                                        ...
                                        <div class="small_btn" id="smb10a">
                                            ...
                                            <button class="rightBtn cen_rightBtn">NEJ</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="sndtrianglemaindiv_2">
                                <div class="sndrectanglebox_2">
                                    ...
                                    <div class="gwd-div-p1hc gwd-div-3m2s" id="Textarea">
                                        <textarea id="txtsm10" style="background-color: rgb(235, 240, 240); height: 126px; width: 196px;" class="gwd-textarea-inzt" readonly></textarea>
                                    </div>
                                    <div class="small_btn" id="smb10b" style="display:none;">
                                        <button id="leftBtn right_leftBtn" class="TB-PREV smb10b" data-block="sm10e" data-bblock="smb10b">TILBAGE</button>
                                        <button id="rightBtn right_rightBtn" data-block="sm10e" data-tarea="txtsm10"  data-bblock="smb10b" data-fld="m10" data-nxt="sm10e" class="TB-NEXT">NÆSTE</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="maincontiner" style="display:block;" id="sm11">
                            ...
                            <div class="sndtrianglemaindiv">
                                <div class="sndrectanglebox">
                                    <div class="calenderredbox">
                                        <h3 class="textdiv">Aftale</h3> 
                                        <div class="cle_top"></div>
                                        <div class="cle_bottom" id="eventdate11">
                                            <h2>?</h2>
                                            <span>Hvornår</span>
                                        </div>
                                    </div>
                                    <p class="textdiv2"></p>
                                    <div class="small_btn" id="calbut11">
                                        <p>
                    ...
                    <div class="maincontiner" id="sm11e" style="display:none;">
                        <div class="center_wrapper">
                            <div class="trianglemaindiv">
                                <div class="rectanglebox">
                                    <div class="image11">
                                ...
                                <div class="sndrectanglebox sndrectangle_center">
                                    <div class="tangleImage">
                                        <div class="calenderredbox1">
                                            <h3 class="textdiv">Aftale</h3> 
                                            <div class="cle_top"></div>
                                            <div class="cle_bottom" id="eventdate111">
                                                <h2>?</h2>
                                                <span>Hvornår</span>
                                            </div>
                                        </div>
                                        <p class="textdiv2">Har du udført udfordringen?</p>
                                        <div class="small_btn" id="smb11a">
                                            <button class="leftBtn cen_leftBtn" id="e_complete11">JA</button>
                                            <button class="rightBtn cen_rightBtn" id="e_ncomplete11">NEJ</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="sndtrianglemaindiv_2">
                                <div class="sndrectanglebox_2">
                                    <h3>Grubletid</h3>
                                    <div class="gwd-div-p1hc gwd-div-3m2s" id="Textarea">
                                        <textarea id="txtsm11" style="background-color: rgb(235, 240, 240); height: 126px; width: 196px;" class="gwd-textarea-inzt" onclick="switchbblock('smb11b')"></textarea>
                                    </div>
                                    <div class="small_btn" id="smb11b" style="display:none;">
                                        <button id="leftBtn right_leftBtn" onclick="clearlb('smb11b')" class="TB-PREV smb11b" >TILBAGE</button>
                                        <button id="rightBtn right_rightBtn" data-block="sm11e" data-tarea="txtsm11"  data-bblock="smb11b" data-fld="m11" data-dismiss="modal" data-nxt="sm11e" class="TB-NEXT">NÆSTE</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
                                ...
                                $(document).ready(function() {
                                    ...
                                    lvcheck('m10', 'sm10e', 'txtsm10');
                                    lvcheck('m11', 'sm11', 'txtsm11');

                                    loaddpevent('m9_event');
                                    loaddpevent('m10_event');
                                    loaddpevent('m11_event');
                                    ...
                                    if (document.getElementById("m11_event").value == 1) {

                                        document.getElementById('sm11').style.display = 'block';
                                    }

                                    if (document.getElementById("txtsm11").value) {
                                        document.getElementById('sm11').style.display = 'none';
                                        document.getElementById('sm11e').style.display = 'block';
                                        $('#e_complete11').addClass("leftBtn1_select");
                                    }
                                ...
                                $(document).on('click', '#e_complete11', function() {
                                    $('#e_complete11').addClass("leftBtn1_select");
                                    document.getElementById("smb11b").style.display = 'block';

                                });

                                $(document).on('click', '#e_ncomplete11', function() {
                                    $('#e_ncomplete11').addClass("leftBtn1_select");
                                ...
                                $(document).on('click', '.TB-NEXT', function() {
                                    ...
                                    if (nxt == 'sm11e') {
                                        //alert('got the issue');
                                        //$('#ModalDepressiveWidget2').modal('hide');
                                ...
                                function clearlb(bblock) {
                                    /*document.getElementById('txtsm11').value="";
                                     document.getElementById(bblock).style.display = 'none';
                                     $('#e_complete11').removeClass("leftBtn1_select");*/
                                        ...
                                        select: function(start, end, allDay) {
                                            ...
                                            if (diff == 10 || diff == -50) {
                                                ...
                                                //if (checkDate32(start)) {
                                                    ...
                                                    createDpact('Grubletid', start, end, 'm11_event');
