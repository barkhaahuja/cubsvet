...
<style>
    ...
    #smb1 .popover, #smb2 .popover,#smb3 .popover, #smb5 .popover, #smb6 .popover, #smb8 .popover, #smb11 .popover, #slb1 .popover, #slb2 .popover, #srb1 .popover,#srb2 .popover {
        width: 175px;
    }
...
<!-- Modal -->
<div class="modal fade" id="ModalLevereglerWidget2" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content shadow window" id="container" style="height: 800px;">
            ...
            <div style="margin-top: 10px; height:730px; float:left; overflow-x: hidden; overflow-y: auto; width:100%; display:block;" id="fullcontent">
                ...
                <section class="nat_contant">
                        ...
                        <div class="exe_singleBox" id="sm3" style="display:none;">
                            ...
                            <div class="exe_singleBorder tablocksm3">
                                ...
                                <div class="n_pBtn" id="smb3" style="display:none;">
                                    <button class="nextBtn smb3" id="prev" data-block="sm3" data-bblock="smb3" data-ctblock="txtsm3" data-ntblock="txtsr2">
                        ...
                        <div class="exe_singleBox" id="sm5" style="display:block;">
                            ...
                            <div class="leveregler_twoBox">
                                ...
                                <div class="exe_singleBorder two2_contentBox tablocksm5">
                                    ...
                                    <textarea id="txtsm5" onclick="switchbblock('smb5', 'tablocksm5', 3)" onkeypress="actmod1('sm5')"></textarea>
                                    <div class="n_pBtn" id="smb5" style="display:none;">
                                        ...
                                        <button class="prevBtn activeBtn sm5" id="next" data-block="sm5" data-tarea="txtsm5"  data-bblock="smb5" data-fld="m5" data-nxt="sm6"  data-hbox="txtsm6">
                            ...
                            <div class="exerciseLeft" id="sl2" style="display:none;">
                                <div class="texareaBox_left tablocksl2">
                                    ...
                                    <div id="slb2" class="PE-TextBoxButtons1" style="display: none;">
                                        <a class="TB-close1_nat exe_npBtn slb2" id="prev" href="#" data-block="sl2" data-bblock="slb2" data-ctblock="txtsl2" data-ntblock="txtsm6">TILBAGE</a>
                                        <a class="TB-tick1_nat exe_npBtn exe_active sl2" id="next" data-block="sl2" data-tarea="txtsl2"  data-bblock="slb2" data-fld="l2" data-nxt="sr2"  data-hbox="txtsr2">NÆSTE</a>
                                    </div>
                                </div>
                            </div>
                            <div class="exe_udfordringBox exe_udfordringBox2 exe_center-center">
                                ...
                                <div class="exe_udfordring exe_udfordring_bottom" id="sm6" style="display:none;">
                                    <div class="exe_udfordring_arrow tablocksm6">
                                        ...
                                        <div class="n_pBtn" id="smb6" style="display:none;">
                                            ...
                                            <button class="prevBtn activeBtn sm6" id="next" data-block="sm6" data-tarea="txtsm6"  data-bblock="smb6" data-fld="m6" data-nxt="sl2" data-hbox="txtsl2">
                            ...
                            <div class="exerciseRight" id="sr2" style="display:none;">
                                <div class="texareaBox_right tablocksr2">
                                    ...
                                    <div id="srb2" class="PE-TextBoxButtons1" style="display: none;">
                                        <a class="TB-close1_nat exe_npBtn srb2" id="prev" href="#" data-block="sr2" data-bblock="srb2" data-ctblock="txtsr2" data-ntblock="txtsm6">TILBAGE</a>
                                        <a class="TB-tick1_nat exe_npBtn exe_active sr2" id="next" href="#" data-block="sr2" data-tarea="txtsr2"  data-bblock="srb2" data-fld="r2" data-nxt="sm7" data-hbox="exe_roundBorder">NÆSTE</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="exe_roundBorder" >
                                ...
                                <div class="round_footer">
                                    ...
                                    <div class="round_btn" id="smb7" style="display:none;">
                                        <button class="nextBtn active" id="next1"  data-block="sm7" data-tarea="txtsm7"  data-bblock="smb7" data-fld="m7" data-nxt="sm8" data-hbox="txtsm8">
                                            Ja
                                        </button>
                    ...
                    <div class="wrapBox">
                        <div class="exe_singleBox" id="sm8" style="display:none;">
                            <div class="udfordring_icon"></div>
                            <div class="exe_singleBorder tablocksm8">
                                <h3>
                                    Hvad skete der?
                                </h3>
                                <textarea id="txtsm8" onclick="switchbblock('smb8', 'tablocksm8', 2)" onkeypress="actmod1('sm8')"></textarea>
                                <div class="n_pBtn" id="smb8" style="display:none;">
                                    <button class="nextBtn smb8" id="prev" data-block="sm8" data-bblock="smb8" data-ctblock="txtsm8" data-ntblock="txtsm7">

                                        <h4>Tilbage</h4>
                                    </button>
                                    <button class="prevBtn activeBtn sm8" id="next" data-block="sm8" data-tarea="txtsm8"  data-bblock="smb8" data-fld="m8" data-nxt="sm9"  data-hbox="">
                    ...
                    <div class="wrapBox">
                        <div class="exe_smallBox" id="sm9" style="display:none;">
                            <div class="udfordring_icon"></div>
                            <div class="exe_singleBorder">
                                <p id="sm4-tt">
                                    <input type="hidden" id="txtsm9" name="txtsm9" value="1" >
                                    Blev din leveregel bekræftet eller afkræftet?
                                </p>
                                <div class="n_pBtn two_Btn" id="smb9" style="display:block;">
                                    <button class="nextBtn" id="prev" data-block="sm9" data-bblock="smb9" data-ctblock="" data-ntblock="txtsm8">
                                        BEKRÆFTET
                                    </button>
                                    <button class="prevBtn sm9"  id="next" data-block="sm9"  data-tarea="txtsm9"  data-bblock="smb9" data-fld="m9" data-nxt="sm10"  data-hbox="">
                                        AFKRÆFTET
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="wrapBox">
                        <div class="exe_smallBox" id="sm10" style="display:none;">
                            <div class="udfordring_icon"></div>
                            <div class="exe_singleBorder">
                                <p id="sm4-tt">
                                    <input type="hidden" id="txtsm10" name="txtsm4" value="1" >
                                    Kan du generalisere denne
                                    erfaring til andre situationer?
                                </p>
                                <div class="n_pBtn two_Btn" id="smb10" style="display:block;">
                                    <button class="nextBtn sm10"  id="next" data-block="sm10" data-tarea="txtsm10"  data-bblock="smb10" data-fld="m10" data-nxt="sm11"  data-hbox="txtsm11">
                                        JA
                                    </button>
                                    <button class="prevBtn"  id="prev" data-block="sm10" data-bblock="smb10" data-ctblock="" data-ntblock="txtsm9">
                                        NEJ
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="wrapBox">
                        <div class="exe_singleBox" id="sm11" style="display:none;">
                            <div class="udfordring_icon"></div>
                            <div class="exe_singleBorder tablocksm11">
                                <h3>
                                    Hvilke situationer?
                                </h3>
                                <textarea id="txtsm11" onclick="switchbblock('smb11', 'tablocksm11', 2)" onkeypress="actmod1('sm11')"></textarea>
                                <div class="n_pBtn" id="smb11" style="display:none;">
                                    <button class="nextBtn smb11" id="prev" data-block="sm11" data-bblock="smb11" data-ctblock="txtsm11" data-ntblock="txtsm10">
                                        
                                        <h4>Tilbage</h4>
                                    </button>
                                    <button class="prevBtn activeBtn sm11" id="next" data-block="sm11" data-tarea="txtsm11"  data-bblock="smb11" data-fld="m11" data-nxt="natexit">
                ...
                <div id="natexit" style="display:none;">
                    <p>  Godt gået! Du er nu færdig med øvelsen. 
                        Dette redskab er nu blevet tilgængeligt 
                        på dit arbejdsbord. Lav endelig flere af 
                        disse udfordringer med andre af dine leveregler.
                    </p>
                    <br>
            ...
            <div id="tooltip-help-sm10" class="popover bottom">
                <p>
            ...
            <div id="tooltip-help-sm11" class="popover bottom">
                <p>
                   I hvilke situationer
kan du bruge denne
erfaring?
...
<script>
                                    ...
                                    $("textarea#txtsm10").popover({
                                        content: $('#tooltip-help-sm10').html(),
                                        html: true,
                                        placement: 'left',
                                        trigger: 'manual'
                                    });
                                    $("textarea#txtsm11").popover({
                                        content: $('#tooltip-help-sm11').html(),
                                        html: true,
                                        placement: 'left',
                                        trigger: 'manual'
                                    });
                                    ...
                                    $(document).ready(function() {
                                        ...
                                        lvcheck('m8', 'sm8', 'txtsm8', id);
                                        lvcheck('m9', 'sm9', 'txtsm9', id);
                                        lvcheck('m10', 'sm10', 'txtsm10', id);
                                        lvcheck('m11', 'sm11', 'txtsm11', id);
                                        ...
                                        preloadlvevent(id);
                                        if (document.getElementById("txtsm11").value) {
                                            document.getElementById('natexit').style.display = 'block';
                                            $('#natexit').focus();
                                            $('.sm9').addClass("active");
                                            $('.sm10').addClass("active");
                                        } else {
                                    ...
                                    $(document).on('click', '#next', function() {
                                        ...
                                        $(".textarea_active").removeClass("textarea_active");
                                         ...
                                         if(block="sm5"){
                                         $(".textarea_5_active").removeClass("textarea_5_active");
                                         }
                                    ...
                                    function levexit() {
                                        $('#ModalLevereglerWidget2').modal('hide');
                                    }
