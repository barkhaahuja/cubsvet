<style>
    ...
    .graph_sideText h3.graph_leftText {
        bottom: 48%;
        left: 5%;
    ...
    .graph_sideText h3.graph_rightText {
        bottom: 19%;
        left: 42.666%;
    }
</style>
<div class="container">
    ...
    <script>
        ...
        function LineChart(con) {
            ...
            this.axisColor = "#555";
            this.pointRadius = 5;
            this.font = "12pt Arial, Helvetica, sans-serif";
            this.fontHeight = 12;
        ...
        LineChart.prototype.drawLine = function (data, color, width) {
            ...
            context.lineWidth = 2;
            context.strokeStyle = '#575761';
            context.fillStyle = '#94C493';
            context.beginPath();
            ...
            for (var n = 0; n < data.length; n++) {
                ...
                context.closePath();
                context.beginPath();
                context.rect((point.x * this.scaleX) - 4, ((point.y * this.scaleY) - 5), 12, 12);
                context.fill();
                context.closePath();
        ...
        var data = <?php echo $gphdata; ?>;
        myLineChart.drawLine(data, "#575761", 15);                

    </script>

</div>
<!-- /container -->
<div class="graph_sideText">
    <h3 class="graph_leftText">
      <?php echo $question_subtitle; ?>
    </h3>
    <h3 class="graph_rightText"><?php echo $question_description; ?></h3>
</div>