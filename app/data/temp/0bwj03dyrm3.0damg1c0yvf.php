<h4>Follow Up Questionnaire</h4>

<div class="row">
    <div class="col-sm-4">
        <div class="radio">
            <label>Dato gang: </label><?php echo $followup_questionnaire_start_date; ?>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="radio">
            <label>Dato Afsluttet: </label> <?php echo $followup_questionnaire_end_date; ?>
        </div>
    </div>
...
<table class="table table-striped table-hover table-bordered">
    ...
    <?php foreach (($followupQuestionnaireResponses?:array()) as $response): ?>
    <tr>
