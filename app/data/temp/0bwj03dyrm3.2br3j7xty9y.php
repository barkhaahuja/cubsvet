...
$(document).ready(function () {
    ...
    var calendar = $('#calendar').fullCalendar({
        ...
        select: function (start, end, allDay) {
			...
			// pradeep - change  for calendar to schedule only past activity.
			// now datetime
			var nowDate = new Date();
			if( nowDate < rend)
			{
				alert('Du kan kun oprette aktiviteter bagud i tid.');
...
//                }
    ...
    $(document).on('click', '#hidecloseblock', function () {
