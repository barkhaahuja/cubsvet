...
<div class="row">
    ...
    <h2>
        <?php if ($PATTERN == '/user/profile'): ?>
            My Profile
            <?php else: ?>
            <?php if ($logged_user->isAdminGroup() || trim($PATTERN)  == '/user/create'): ?>
                Add User
                <?php else: ?>
	...
	<?php if (isset($GET['err']) && $GET['err'] == 1): ?>
        <div class="alert alert-danger">
			<?php if (isset($GET['phone']) && $GET['phone'] != ''): ?>
				We cannot update this user <?php echo $GET['phone']; ?> phone is already associated with another user.
			<?php endif; ?>
			<?php if (isset($GET['email']) && $GET['email'] != ''): ?>
				We cannot update this user <?php echo $GET['email']; ?> email is already associated with another user.
			<?php endif; ?>
		</div>
    <?php endif; ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" id="email" name="email" autocomplete="off"
                           ...
                           placeholder="Email" onblur="checkEmailAvailability();"/>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" id="phone" name="phone" autocomplete="off"
                           ...
                           placeholder="Phone" onblur="validPhone();"/>
...
Include lowercase and uppercase alphabetic characters, numbers and symbols.</div>
    ...
    <div class="form-group">
        <div class="pull-right">
            ...
            <button type="submit" class="btn btn-primary btn-lg" onmousedown="checkSteps()">
...
<script>
    $(document).ready(function () {
        ...
        <?php if (substr($PATTERN,0,12) == '/user/update'): ?>
                $('#editpage').validate({
            rules: {
                name: {
                    minlength: 2,
