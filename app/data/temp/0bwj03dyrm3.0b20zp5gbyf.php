...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="LoginHolding">
            ...
            <?php if (isset($GET['notification']) AND  $GET['notification'] == 'error.credentials'): ?>
                <div id="loginAlertR">
                    <div class="loginAlertCross"></div>
                    <p>Password Forkert.<br><br></p>
                                </div>
                                <?php endif; ?>
                                ...
                                <?php endif; ?>
													...
													<?php endif; ?>
                                                        ...
                                                        <div class="InputTextBox pass"><input class="InputText" name="password" type="password"
                                                                                              placeholder="Adgangskode"
                                                                                              maxlength="200"/></div>
                                                        <input type='submit' accesskey="enter" value='LOG IND' id="LoginButton"  />
                                                    </form>
