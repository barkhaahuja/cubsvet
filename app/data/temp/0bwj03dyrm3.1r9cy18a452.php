...
<!-- Modal -->
<div class="modal fade" id="ModalDepressiveWidget3" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" style="width: 1200px;">
        <div class="modal-content shadow window" id="container" style="height: 800px;">
                            ...
                            <div class="gwd-div-epbp-confirm" style="background-color:#ffffff; padding: 10px; color:#8ED2CC; height:130px; border:0px; border-color: white;">
                                ...
                                <div id="nthoughts" style="float:left; display:block;">
                                    ...
                                    <div id="innerlistblock" style="height: auto; width:250px;  background-color: black; position:relative; left:44px;">
                                        ...
                                        <div  id="thoughts1" class="thoughts" style="background-color: #8ED2CC;">
                                            <a href="#" class="thoughts" data-id="m9" data-text="m9" data-dismiss="modal" style="text-decoration:none;background-color: #8ED2CC;">Afledende aktiviteter</a>
                        ...
                        <div class="center_wrapper">
                            ...
                            <div class="sndtrianglemaindiv_2">
                                <div class="sndrectanglebox_2">
                                    ...
                                    <div class="gwd-div-p1hc gwd-div-3m2s tablocksm9e" id="Textarea">
                                        <textarea id="txtsm9" style="background-color: rgb(235, 240, 240); height: 126px; width: 196px;" class="gwd-textarea-inzt" onclick="switchbblock('smb9b', 'tablocksm9e', 1)" onkeypress="actmod('sm9e')"></textarea>
                                    </div>
                                    <div class="small_btn" id="smb9b" style="display:none;">
                                        <button id="leftBtn right_leftBtn" data-block="sm9" data-bblock="smb9b" class="TB-PREV smb9b">TILBAGE</button>
                                        <button id="rightBtn right_rightBtn" data-block="sm9e" data-tarea="txtsm9"  data-bblock="smb9b" data-fld="m9" data-nxt="sm9e" class="TB-NEXT active_nextBtn sm9e">NÆSTE</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div id="tooltip-thoughts1" class="popover left">
...
<script>
                                ...
                                //---toolbox---------------------------
                                $("#thoughts1").popover({
                                    content: $('#tooltip-thoughts1').html(),
                                    html: true,
                                    placement: 'left',
                                    trigger: 'click'
                                });
                                ...
                                $(document).ready(function() {
                                    ...
                                    if (document.getElementById("txtsm6").value) {

                                        document.getElementById('sm7').style.display = 'block';

                                    }

                                    if (document.getElementById("txtsm8").value && document.getElementById("txtsm7").value == 1) {
                                        document.getElementById('tbox').style.display = 'block';


                                        hidePopovers();
                                        $('#thoughts1').popover('show');
                                    }
                                ...
                                $(document).on('click', '.thoughts', function() {
                                    ...
                                    if (id == "m9") {
                                        ...
                                        $('#ModalDepressiveWidget3').modal('hide');
