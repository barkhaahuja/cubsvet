...
<!-- Modal -->
<div class="modal fade" id="ModalDepressiveWidget" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" style="width: 1200px;">
        <div class="modal-content shadow window" id="container" style="height: 800px;">
            ...
            <div style="margin-top: 10px; height:730px; float:left; overflow-x: hidden; overflow-y: auto; width:100%; display:block;" id="fullcontent">
               ...
               <input type="hidden" id="elmblk" name="elmblk" value="" />
                ...
                <div class="wrapper">
                    ...
                    <div class="lefttopBox" id="sl1" style="display:none;">
                        ...
                        <div class="small_btn" id="slb1" style="display:none;">
                            <div class="leftbox tb_bg_prev">
                                <a class="TB-PREV slb1" href="javascript:void(0)" data-block="sl1" data-bblock="slb1" data-ctblock="txtsl1" data-ntblock="txtsm1">TILBAGE</a>
                            </div>
                            ...
                            <div id="mainleftBox">
                                ...
                                <div class="gwd-div-fbur" id="Leftbox">
                                    ...
                                    <div class="small_btn" id="smb2l" style="display:none;">
                                        <button id="leftBtn" data-block="sm2l"  data-bblock="smb2l" class="TB-PREV smb2l" data-ctblock="txtsm21" data-ntblock="txtsl1">TILBAGE</button>
                            ...
                            <div class="gwd-div-epbp">
                                ...
                                <div class="singleRight">
                                    ...
                                    <div class="small_btn_rep" id="smb3" style="display:none;">
                                        <button id="leftBtn" data-block="sm3"  data-bblock="smb3"   class="TB-PREV smb3" data-ctblock="txtsm3" data-ntblock="txtsmr2">TILBAGE</button>
                            ...
                            <div class="gwd-div-epbp">
                                ...
                                <div class="singleRight">
                                    ...
                                    <div class="small_btn_rep" id="smb8" style="display:none;">
                                        <button id="leftBtn" data-block="sm8"  data-bblock="smb8"   class="TB-PREV smb8" data-ctblock="txtsm8" data-ntblock="txtsl1">TILBAGE</button>
                    ...
                    <div class="maincontiner" style="display:none;" id="sm9">
                            ...
                            <div class="sndtrianglemaindiv">
                                <div class="sndrectanglebox">
                                    <div class="calenderredbox">
                                        ...
                                        <div class="cle_bottom" id="eventdate">
                                            <h2>?</h2>
                                            <span>Hvornår</span>
                                        </div>
                                    </div>
                                    <p class="textdiv2"></p>
                                    <div class="small_btn" id="calbut">
                                        <p>
                    ...
                    <div class="maincontiner" id="sm9e" style="display:none;">
                                ...
                                <div class="sndrectanglebox sndrectangle_center">
                                    <div class="tangleImage">
                                        ...
                                        <div class="small_btn" id="smb9a">
                                            <button class="leftBtn cen_leftBtn" id="e_complete">JA</button>
                                            <button class="rightBtn cen_rightBtn" id="e_ncomplete">NEJ</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="sndtrianglemaindiv_2">
                                <div class="sndrectanglebox_2">
                                    ...
                                    <div class="gwd-div-p1hc gwd-div-3m2s" id="Textarea">
                                        <textarea id="txtsm9" style="background-color: rgb(235, 240, 240); height: 126px; width: 196px;" class="gwd-textarea-inzt" onclick="switchbblock('smb9b')"></textarea>
                                    </div>
                                    <div class="small_btn" id="smb9b" style="display:none;">
                                        <button id="leftBtn right_leftBtn" class="TB-PREV smb9b" onclick="clearlb('smb9b')">TILBAGE</button>
                                        <button id="rightBtn right_rightBtn" data-block="sm9e" data-tarea="txtsm9"  data-bblock="smb9b" data-fld="m9" data-nxt="tbox" class="TB-NEXT">NÆSTE</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="gwd-div-epbp-confirm" style="background-color:#ffffff; padding: 10px; color:#8ED2CC; height:130px; border:0px; border-color: white;">
                                ...
                                <div id="nthoughts" style="float:left; display:block;">
                                    ...
                                    <div id="innerlistblock" style="height: auto; width:250px;  background-color: black; position:relative; left:44px;">
                                        ...
                                        <div class="thoughts" id="thoughts2" style="background-color: #8ED2CC;">
                                            <a href="#" class="thoughts" data-id="m10" data-text="m10" data-dismiss="modal" style="text-decoration:none;background-color: #8ED2CC;">Problemløsning</a>

                                        </div>
                                        <div class="thoughts" id="thoughts3">
                                            <a href="#" class="thoughts" data-id="m11" data-text="m11" data-dismiss="modal" style="text-decoration:none;">Grubletid</a>
            ...
            <div id="tooltip-thoughts2" class="popover left">
            ...
            <div id="click_popOverBox9" class="click_popOverBox_DP popover top">
                <p>Du har klikket på TILBAGE. Det du har skrevet vil ikke blive gemt. Vil du fortsætte alligevel?</p>
                <div class="popOver_btn_dp">
                    <button class="prevBtnDP" onclick="confirmCancel()">NEJ</button>
                    <button class="nextBnDP" onclick="confirmOk9()">JA</button>
                </div>
            </div>
...
<script>
                                ...
                                $('.smb9b').popover({
                                    content: $('#click_popOverBox9').html(),
                                    html: true,
                                    placement: 'top',
                                    trigger: 'click'
                                });
                                ...
                                //---toolbox---------------------------
                                $("#thoughts").popover({
                                    content: $('#tooltip-thoughts2').html(),
                                    html: true,
                                    placement: 'left',
                                    trigger: 'manual'
                                });
                                ...
                                $(document).ready(function() {
                                    ...
                                    if (document.getElementById("txtsm7").value == 1) {
                                    ...
                                    } else if (document.getElementById("txtsm7").value == 2) {
                                    ...
                                    if (document.getElementById("txtsm8").value) {
                                        document.getElementById('tbox').style.display = 'none';
                                        document.getElementById('sm9').style.display = 'block';
                                    }

                                    if (document.getElementById("txtsm9").value) {
                                        document.getElementById('sm9').style.display = 'none';
                                        document.getElementById('sm9e').style.display = 'block';
                                ...
                                $(document).on('click', '#e_complete', function() {
                                    $('#e_complete').addClass("leftBtn1_select");
                                    document.getElementById("smb9b").style.display = 'block';

                                });

                                $(document).on('click', '#e_ncomplete', function() {
                                    $('#e_ncomplete').addClass("leftBtn1_select");
                                ...
                                $(document).on('click', '.thoughts', function() {
                                    ...
                                    if (id == "m10") {
                                        ...
                                        $('#ModalDepressiveWidget').modal('hide');
                                ...
                                function clearlb(bblock) {
                                    /*document.getElementById('txtsm9').value="";
                                     document.getElementById(bblock).style.display = 'none';
                                     $('#e_complete').removeClass("leftBtn1_select");*/
                                        ...
                                        select: function(start, end, allDay) {
                                            ...
                                            if (diff == 10 || diff == -50) {
                                                ...
                                                //if (checkDate32(start)) {
                                                    ...
                                                    createDpact('Afledende aktiviteter', start, end, 'm9_event');
