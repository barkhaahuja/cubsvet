...
<div id="DashboardContainer">
    ...
    <div id="Dash-right-MainBox">
        <div style="padding: 30px;">
            ...
            <div style="font-size: 14px;margin-top: 20px;">
                ...
                <form action="<?php echo $ROOT; ?>/user/update_simple" method="POST" name="info-form" >
                    ...
                    <table class="table">
                        <tr>
                            <td>Navn</td>
                            <td><input name="name" id="name" value="<?php echo $user['name']; ?>" data-original="<?php echo $user['name']; ?>"
            ...
            <div style="font-size: 14px;margin-top: 20px;">
                <form action="<?php echo $ROOT; ?>/user/update_simple" method="POST" name="pass-form" id="pass-form">
                    <input type="hidden" value="<?php echo $user['id']; ?>" name="id"/>
                    <table class="table">
                        <tr>
