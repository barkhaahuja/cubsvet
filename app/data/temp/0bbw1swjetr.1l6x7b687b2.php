...
<div class="row">
    ...
    <table class="table table-striped table-hover table-bordered">
        ...
        <tr>
            ...
            <td>
                <?php if (!empty($a['m9'])): ?>
                    Scheduled from <?php echo $a['m9_event_start']; ?> - <?php echo $a['m9_event_end']; ?>
                <?php endif; ?>
                <br/><br/><br/><br/>
        ...
        <tr>
            <td>
              ...
              <td>
                <?php if (!empty($a['m10'])): ?>
                  Scheduled from <?php echo $a['m10_event_start']; ?> - <?php echo $a['m10_event_end']; ?>
                <?php endif; ?>
                 <br/><br/><br/><br/>
                 <?php if (($a['m9_status']==1)): ?>JA<?php endif; ?>
                 <?php if (($a['m9_status']==2)): ?>NEJ<?php endif; ?>
         ...
         <tr>
            <td>
             ...
             <td>
                 <?php if (!empty($a['m11'])): ?>
                    Scheduled from <?php echo $a['m11_event_start']; ?> - <?php echo $a['m11_event_end']; ?>
                 <?php endif; ?>
                <br/><br/><br/><br/>
                <?php if (($a['m9_status']==1)): ?>JA<?php endif; ?>
                <?php if (($a['m9_status']==2)): ?>NEJ<?php endif; ?>             
