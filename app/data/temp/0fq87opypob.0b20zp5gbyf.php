        ...
        <div id="LoginHolding">
            ...
            <?php if (isset($GET['notification']) AND  $GET['notification'] == 'success.mail'): ?>
                <div id="loginAlertG">
                    ...
                    <p>Your password has now been sent to your email.</p>
                </div>
            <?php endif; ?>
...
<?php endif; ?>
    ...
    <form id="form-login" method="post" action="/check_login">
        ...
        <div class="InputTextBox pass"><input class="InputText" id="password" name="password" type="password"
                                              ...
                                              maxlength="200"/></div>
        <input type='submit' onclick="login();" accesskey="enter" value='LOGIN' id="LoginButton" />
    </form>



    <a class="lostpass" href="/recover_password">Forgot your password?</a>
